...
# list_1 = [1, 2, 3]
# list_2 = list_1[ : ] # копирование среза списка
# list_2 = list_1.copy() # встроенный метод списка
# Но, если в первоначальном списке есть вложенные списки, то надо использовать глубокое копирование через импортированный модуль:

# from copy import deepcopy

# list_1 = [1, [1, 2], 3, [3, 4, 5], 6]
